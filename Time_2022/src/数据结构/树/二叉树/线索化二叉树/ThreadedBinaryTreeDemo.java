package 数据结构.树.二叉树.线索化二叉树;

/**
 * @title: ThreadedBinaryTreeDemo
 * @Author zxwyhzy
...
public class ThreadedBinaryTreeDemo {
    ...
    public static void main(String[] args) {
        ...
        threadedBinaryTree.threadedNodes3();
        ...
        threadedBinaryTree.threadedList3(root);
...
class ThreadedBinaryTree {
    ...
    //重载一把threadedNodes2方法
    public void threadedNodes2() {
        this.threadedNodes2(root);
    }
    public void threadedNodes3() {
        this.threadedNodes3(root);
    }
    ...
    public void threadedList3(HeroNode node) {
